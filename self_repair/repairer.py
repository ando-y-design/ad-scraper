...
# Claude CLIパスのキャッシュ
_cached_claude_cmd: str | None = None
...
def _get_claude_cmd() -> tuple[str | None, bool]:
    """
...
def _backup_file(filepath: Path) -> Path | None:
...
def _apply_function_patches(original_code: str, response: str) -> str | None:
    """
